...
echo $this->indent . htmlspecialchars( "	<?php echo esc_html( \${$this->var_name}['address'] ); ?>" ) . "\n";
echo $this->indent . htmlspecialchars( "	<?php echo esc_html( \${$this->var_name}['lat'] ); ?>" ) . "\n";
echo $this->indent . htmlspecialchars( "	<?php echo esc_html( \${$this->var_name}['lng'] ); ?>" ) . "\n";
echo $this->indent . htmlspecialchars( "	<?php echo esc_html( \${$this->var_name}['zoom'] ); ?>" ) . "\n";
...
echo $this->indent . htmlspecialchars( "			<?php echo esc_html( \${$this->var_name}[ \$key ] ); ?>" ) . "\n";
